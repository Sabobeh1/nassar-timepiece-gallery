    ...
    <section className="mb-12 py-8">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-playfair font-bold text-Rolex-black">
        ...
        {visibleWatches < watches.length && (
          <div className="mt-8 text-center">
            <button 
              ...
              className="inline-block px-6 py-2 bg-Rolex-cream text-Rolex-black font-montserrat text-sm font-medium border border-gold hover:bg-gold hover:text-white transition-colors rounded"
            >
              Load More
            </button>
          </div>

...
const CartDropdown = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="p-4 min-w-[90vw] sm:min-w-[320px]">
  ...
  return (
    <div className="relative p-3 min-w-[95vw] sm:min-w-[320px] max-h-[80vh] overflow-y-auto flex flex-col">
      ...
      <div className="sticky bottom-0 left-0 bg-white pt-4 z-10 mt-auto">

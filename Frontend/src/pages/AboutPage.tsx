    ...
    <div className="min-h-screen flex flex-col bg-Rolex-cream">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                <h1 className="text-4xl font-playfair font-bold text-Rolex-black mb-4">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-playfair font-bold text-Rolex-black text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h3 className="text-xl font-playfair font-bold text-Rolex-black mb-3">Quality</h3>
                <p className="text-Rolex-charcoal/80">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h3 className="text-xl font-playfair font-bold text-Rolex-black mb-3">Authenticity</h3>
                <p className="text-Rolex-charcoal/80">
                  Every watch in our collection is guaranteed authentic, sourced directly from authorized
                  dealers or trusted partners in the Rolex watch industry.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h3 className="text-xl font-playfair font-bold text-Rolex-black mb-3">Integrity</h3>
                <p className="text-Rolex-charcoal/80">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h3 className="text-xl font-playfair font-bold text-Rolex-black mb-3">Excellence</h3>
                <p className="text-Rolex-charcoal/80">
        ...
        <section className="bg-white py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-playfair font-bold text-Rolex-black text-center mb-8">
